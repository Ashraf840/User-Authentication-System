"""
Django settings for dj_jwt_auth project.
...
SECRET_KEY = "django-insecure-*5orwifwvpj3at&&cj1pvv$y!uui2_3tyn!r@vgtusrjpex)zz"
...
WSGI_APPLICATION = "dj_jwt_auth.wsgi.application"
...
# Ref:  https://www.javatpoint.com/how-to-connect-mysql-to-django
DATABASES = {  
    'default': {  
